...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF26A0DA);
  late Color secondary = const Color(0xFF993399);
  late Color tertiary = const Color(0xFFFF5722);
  late Color alternate = const Color(0xFFCC99CC);
  ...
  late Color accent1 = const Color(0xFF42647B);
  late Color accent2 = const Color(0xFF663399);
  late Color accent3 = const Color(0xFFFF9900);
  ...
  late Color fundo = const Color(0xFF314755);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF26A0DA);
  late Color secondary = const Color(0xFF993399);
  late Color tertiary = const Color(0xFFFF3366);
  late Color alternate = const Color(0xFF663399);
  ...
  late Color accent1 = const Color(0xFF42647B);
  late Color accent2 = const Color(0xFFCC66FF);
  late Color accent3 = const Color(0xFF993399);
  ...
  late Color fundo = const Color(0xFFFDBA2F);
  late Color customColor1 = const Color(0xFFFFFFFF);
}
