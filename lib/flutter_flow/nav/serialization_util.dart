  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case EnquetesRow:
            return EnquetesRow(data);
          case ResponsaveisAlunosRow:
            return ResponsaveisAlunosRow(data);
          case TarefasRow:
            return TarefasRow(data);
          case EventosUsuariosRow:
            return EventosUsuariosRow(data);
          case DiaADiaRow:
            return DiaADiaRow(data);
          case CardapiosRow:
            return CardapiosRow(data);
          case PerfisRow:
            return PerfisRow(data);
          case DisciplinasRow:
            return DisciplinasRow(data);
          case AlunosRow:
            return AlunosRow(data);
          case AutorizacoesRow:
            return AutorizacoesRow(data);
          case GaleriaFotosRow:
            return GaleriaFotosRow(data);
          case TurmasRow:
            return TurmasRow(data);
          case EventosTurmasRow:
            return EventosTurmasRow(data);
          case ComunicadosUsuariosRow:
            return ComunicadosUsuariosRow(data);
          case CursosRow:
            return CursosRow(data);
          case ProfessoresTurmasDisciplinasRow:
            return ProfessoresTurmasDisciplinasRow(data);
          case RespostasEnquetesRow:
            return RespostasEnquetesRow(data);
          case ConfirmacaoPresencaRow:
            return ConfirmacaoPresencaRow(data);
          case ComunicadosTurmasRow:
            return ComunicadosTurmasRow(data);
          case ComunicadosRow:
            return ComunicadosRow(data);
          case EventosRow:
